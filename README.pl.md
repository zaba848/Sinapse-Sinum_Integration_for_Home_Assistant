...
[![Tests](https://img.shields.io/badge/testy-1743%20OK-brightgreen.svg)](tests/)
[![CC Gate](https://img.shields.io/badge/CC-%E2%89%A44%20everywhere-brightgreen.svg)](tests/test_code_quality.py)
[![Version](https://img.shields.io/badge/wersja-0.7.5-blue.svg)](custom_components/sinum/manifest.json)
...
- **1 715 przechodzących testów** w 46 plikach, CC ≤ 4 w każdej funkcji, czysty ruff i mypy
