...
[![Tests](https://img.shields.io/badge/tests-1682%20passing-brightgreen.svg)](tests/)
[![CC Gate](https://img.shields.io/badge/CC-≤4%20everywhere-brightgreen.svg)](tests/test_code_quality.py)
[![Version](https://img.shields.io/badge/version-0.7.3-blue.svg)](custom_components/sinum/manifest.json)
...
- **1 682 passing tests** across 46 test files, CC ≤ 4 on every function, ruff and mypy clean
