...
[![Tests](https://img.shields.io/badge/tests-1481%20passing-brightgreen.svg)](tests/)
[![CC Gate](https://img.shields.io/badge/CC-≤4%20everywhere-brightgreen.svg)](tests/test_code_quality.py)
[![Version](https://img.shields.io/badge/version-0.5.5-blue.svg)](custom_components/sinum/manifest.json)
...
4. Settings → … → Sinum → Configure → Enable WebSocket real-time transport
```
