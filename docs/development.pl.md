...
tests/
  ...
  └── test_*.py                1675 przechodzących testów dla wszystkich platform i typów urządzeń
```
...
Statystyki testów: **1675 przechodzących testów, 5 pominiętych testów live-write, 46 plików testów**, czas wykonania ~10 s. Wszystkie testy niesprzętowe muszą przejść przed mergem.
...
| Testy | `pytest` | Wszystkie 1675 testów niesprzętowych przechodzą |
...
- [ ] `pytest tests/` — wszystkie 1675 testów niesprzętowych przechodzą
